...
class Order(models.Model):
    ...
    prepaid = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True, default=0, verbose_name='Предоплата')
...
class Work(models.Model):
    ...
    price = models.DecimalField(max_digits=15, decimal_places=2, blank=True, default=0, verbose_name='Цена')
    warranty = models.CharField(max_length=20,  blank=True, null=True, verbose_name='Гарантия')
